import * as emotion from 'emotion/types'
import { Interpolation as EmotionInterpolation } from 'emotion/types'
import { ComponentClass, CSSProperties, StatelessComponent } from 'react'
...
type Component<Props> = ComponentClass<Props> | StatelessComponent<Props>
...
export interface ThemedReactEmotionInterface<Theme>
